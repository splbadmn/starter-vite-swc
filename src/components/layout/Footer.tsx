    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Monorays</h3>
            <p className="text-gray-400 mb-4">
              Providing innovative engineering solutions for over 25 years. We
              specialize in civil engineering, structural design, and project
              management.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@monorays.org</span>
              </li>
            </ul>
          </div>
        </div>
